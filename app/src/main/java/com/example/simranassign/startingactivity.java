package com.example.simranassign;
...
public class startingactivity extends AppCompatActivity implements OnMapReadyCallback {
        ...
        maptype.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (maptype.getSelectedItem() == "Satelite") {
                    ...
                    Toast.makeText(startingactivity.this, "Satelite", Toast.LENGTH_SHORT).show();


                }
                if (maptype.getSelectedItem() == "Hybride") {
                    mMap.setMapType(GoogleMap.MAP_TYPE_HYBRID);
                    Toast.makeText(startingactivity.this, "Hybride", Toast.LENGTH_SHORT).show();
                } if(maptype.getSelectedItem() == "Default")
                {
                    mMap.setMapType(GoogleMap.MAP_TYPE_TERRAIN);
                    Toast.makeText(startingactivity.this, "Terrain", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                Toast.makeText(startingactivity.this, "hi", Toast.LENGTH_SHORT).show();
                setMarker(location);
                getAddress(location);
        ...
        try {
            ...
            if (!addresses.isEmpty()) {
                ...
                if (mDatabase.addFavPlace(addresses.get(0).getLocality(),addDate,addresses.get(0).getAddressLine(0),location.getLatitude(),location.getLongitude())){
                    Toast.makeText(startingactivity.this, "plce"+addresses.get(0).getAddressLine(0), Toast.LENGTH_SHORT).show();
                    // System.out.println(mDatabase.getAllPlace().toString());
                    // loadEmployees();
                }else {
                    Toast.makeText(startingactivity.this, "Employee is not addaed", Toast.LENGTH_SHORT).show();
                }
...
//    }
    ...
    private String getUrl(double lat, double longi, String nearplace) {
        ...
        placeurl.append("&type:" + nearplace);
        placeurl.append("&key=AIzaSyB0x3UouAkkoxPrN17yi3LUzg2JO2pnFxU");
        // https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=43.647845,-79.3888367&radius=1000$typerestaurant&key=AIzaSyDK2Du7rvxW4d4NQmKg8qAyxaZ0dGgaY5k
        //System.out.println(placeurl.toString());
        return placeurl.toString();
    }
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                for (Location location : locationResult.getLocations()) {
                    ...
                    mMap.addMarker(new MarkerOptions().position(userLoaction).title("Your Location").icon(bitmapDescriptorFromVector(getApplicationContext(), R.drawable.mapicon)));
                }
            }
        };
    }
